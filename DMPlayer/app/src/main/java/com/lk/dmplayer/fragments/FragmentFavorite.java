...
public class FragmentFavorite extends Fragment {
    ...
    private void setupInitialViews(View v) {
        ...
        allSongsListAdapter.setType(PhoneMediaControl.SonLoadFor.Favorite.ordinal());
    ...
    private void loadAllSongs() {
        ...
        phoneMediaControl.loadMusicList(getActivity(), -1, PhoneMediaControl.SonLoadFor.Favorite, "");
    }
}
